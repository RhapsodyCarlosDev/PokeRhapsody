...
namespace Pokemon
{
    public partial class FestivalBrillante: Form
    {
        public FestivalBrillante()
        {
            InitializeComponent();
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    koreano >= 0 && chino >= 0)
                {
                    ...
                    string checkSql = "SELECT COUNT(*) FROM festival_brillante WHERE Codigo = @Codigo";
                    ...
                    else
                    {
                        ...
                        string sql = "INSERT INTO festival brillante (Codigo, Nombre, Tipo, PS, Habilidad, Ataque1, NEA1, Ataque2, NEA2, Ataque3, " +
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            string sql1 = "SELECT * FROM festival_brillante WHERE Codigo LIKE '" + codigo + "'";
            string sql2 = "SELECT * FROM festival_brillante WHERE Nombre LIKE '" + nombre + "'";
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE festival_brillante SET Codigo = '" + codigo + "', Nombre = '" + nombre + "', Tipo = '" + tipo + "'," +
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(codigo))
                {
                    ...
                    {
                        string sqlEliminarCodigo = "DELETE FROM festival_brillante WHERE Codigo = @codigo";
                ...
                else if (!string.IsNullOrEmpty(nombre))
                {
                    ...
                    string sqlContarNombre = "SELECT COUNT(*) FROM festival_brillante WHERE Nombre = @nombre";
                    ...
                    else
                    {
                        ...
                        if (eliminar == DialogResult.Yes)
                        {
                            string sqlEliminarNombre = "DELETE FROM festival_brillante WHERE Nombre = @nombre";
